...
<html>
  <head>
    ...
    <meta name="author" content="daniel yamada">
...
<form method="post" class="text-center form-validate" >
            ...
            <div class="form-outer d-flex align-items-center">
                ...
                <div class="form-inner dashboard-counts" style = "width:100%" >
                    ...
                    <div class="col-12 pt-2 mb-4 ">
                        <div class=" count-title d-flex">
                            <div class="col-sm-12">
                                <a class="row" href="app/login.php">
                                    <div class="icon ml-2"><i class="fas fa-user"></i></div>
                                    <div class="name ml-1"><strong class="text-uppercase"> Login para quem já tem cadastro</strong></div>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-4 ">
                        <div class=" count-title d-flex ">
                            <div class="col-sm-12 ">
                                <a class="row" href="app/register.php">
                                    <div class="icon ml-2"><i class="far fa-file-alt"></i></div>
                                    <div class="name ml-1"><strong class="text-uppercase"> Criar Cadastro (caso não tenha)</strong></div>
                                </a>
                            </div>
                        </div>
                    </div>
