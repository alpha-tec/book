    ...
    <div class="card border-0">
        ...
        <?php
            ...
            if( isset($_POST['searchCEP']) ){
                ...
                $lista = $endereco->searchPostalCode($_POST['cep']);
            ...
            <form class="form-signin"  method="post" action="">
                <div class="text-center"><h4>ENDEREÇO</h4><br></div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="row"  id="div_view">
                            ...
                            <div class=" form-group col-sm-4">
                                <div class="input-group mb-2">
                                    ...
                                    <input name="inPostalCode" type="text" data-mask="99999-999" class="custom-select custom-select-sm " placeholder="" data-msg="Número do CEP" aria-label="Default" aria-describedby="basic-addon2"  value="<?php echo $lista3->postal_code; ?>" required readonly>
                            ...
                            <div class=" form-group col-sm-8">
                                ...
                                <input name="inAddress" type="text" placeholder="" data-msg="Nome do logradouro" class="form-control form-control-sm " aria-label="Default" style="text-transform:uppercase" value="<?php echo $lista3->address; ?>" required >
                            </div>

                            <div class=" form-group col-sm-6 ">
                                <label class="form-control-label col-form-label col-12 pl-0 ">Bairro</label>
                                <input name="inNeighborhood" type="text" placeholder="" data-msg="Bairro" class="form-control form-control-sm " aria-label="Default" style="text-transform:uppercase" value="<?php echo $lista3->neighborhood;?>" required >
                            </div>

                            <div class=" form-group col-sm-2 ">
                                <label class="form-control-label col-form-label col-12 pl-0 ">Número</label>
                                <input name="inNumber" type="text" placeholder="" data-msg="Número" class="form-control form-control-sm " aria-label="Default" value="<?php echo $lista3->number; ?>" <?php if($number_focus == 1) echo ' autofocus ';?> required>
                            </div>

                            <div class=" form-group col-sm-4 ">
                                <label class="form-control-label col-form-label col-12 pl-0 ">Complemento</label>
                                <input name="inComplement" type="text" placeholder="Complemento (EX. APTO 71)" class="form-control form-control-sm " aria-label="Default" style="text-transform:uppercase" value="<?php echo $lista3->complement; ?>">
                            </div>

                            <div class=" form-group col-sm-8 ">
                                <label class="form-control-label col-form-label col-12 pl-0 ">Cidade</label>
                                <input name="inCity" type="text" placeholder="" data-msg="Informe a Cidade" class="form-control form-control-sm " aria-label="Default" style="text-transform:uppercase" value="<?php echo $lista3->city;?>" required >
                            </div>
                            ...
                            <div class=" form-group col-sm-4 ">
                                ...
                                <select name="inStateCode" class="form-control form-control-sm " data-msg="Escolha o Estado" aria-label="Default" required >
                                    <option value=''></option>
                                    <option value='AL' <?php if($lista3->state == 'AL') echo 'selected'; ?> >ALAGOAS</option>
                                    <option value='AM' <?php if($lista3->state == 'AM') echo 'selected'; ?> >AMAZONAS</option>
                                    <option value='AP' <?php if($lista3->state == 'AP') echo 'selected'; ?> >AMAPÁ</option>
                                    <option value='AC' <?php if($lista3->state == 'AC') echo 'selected'; ?> >ACRE</option>
                                    <option value='BA' <?php if($lista3->state == 'BA') echo 'selected'; ?> >BAHIA</option>
                                    <option value='CE' <?php if($lista3->state == 'CE') echo 'selected'; ?> >CEARÁ</option>
                                    <option value='DF' <?php if($lista3->state == 'DF') echo 'selected'; ?> >DISTRITO FEDERAL</option>
                                    <option value='ES' <?php if($lista3->state == 'ES') echo 'selected'; ?> >ESPÍRITO SANTO</option>
                                    <option value='GO' <?php if($lista3->state == 'GO') echo 'selected'; ?> >GOIÁS</option>
                                    <option value='MA' <?php if($lista3->state == 'MA') echo 'selected'; ?> >MARANHÃO</option>
                                    <option value='MG' <?php if($lista3->state == 'MG') echo 'selected'; ?> >MINAS GERAIS</option>
                                    <option value='MS' <?php if($lista3->state == 'MS') echo 'selected'; ?> >MATO GROSSO DO SUL</option>
                                    <option value='MT' <?php if($lista3->state == 'MT') echo 'selected'; ?> >MATO GROSSO</option>
                                    <option value='PA' <?php if($lista3->state == 'PA') echo 'selected'; ?> >PARÁ</option>
                                    <option value='PB' <?php if($lista3->state == 'PB') echo 'selected'; ?> >PARAIBA</option>
                                    <option value='PE' <?php if($lista3->state == 'PE') echo 'selected'; ?> >PERNAMBUCO</option>
                                    <option value='PI' <?php if($lista3->state == 'PI') echo 'selected'; ?> >PIAUÍ</option>
                                    <option value='PR' <?php if($lista3->state == 'PR') echo 'selected'; ?> >PARANÁ</option>
                                    <option value='RJ' <?php if($lista3->state == 'RJ') echo 'selected'; ?> >RIO DE JANEIRO</option>
                                    <option value='RN' <?php if($lista3->state == 'RN') echo 'selected'; ?> >RIO GRANDE DO NORTE</option>
                                    <option value='RO' <?php if($lista3->state == 'RO') echo 'selected'; ?> >RONDÔNIA</option>
                                    <option value='RR' <?php if($lista3->state == 'RR') echo 'selected'; ?> >RORAIMA</option>
                                    <option value='RS' <?php if($lista3->state == 'RS') echo 'selected'; ?> >RIO GRANDE DO SUL</option>
                                    <option value='SC' <?php if($lista3->state == 'SC') echo 'selected'; ?> >SANTA CATARINA</option>
                                    <option value='SE' <?php if($lista3->state == 'SE') echo 'selected'; ?> >SERGIPE</option>
                                    <option value='SP' <?php if($lista3->state == 'SP') echo 'selected'; ?> >SÃO PAULO</option>
                                    <option value='TO' <?php if($lista3->state == 'TO') echo 'selected'; ?> >TOCANTINS</option>
                                    <option value='NA' <?php if($lista3->state == 'NA') echo 'selected'; ?> >OUTRO</option>
                                </select>
                            </div>

                            <div class=" form-group col-sm-4 ">
                                <label class="form-control-label col-form-label col-12 pl-0 ">País</label>
                                <input name="inCountry" type="text" placeholder="" data-msg="Informe o País" class="form-control form-control-sm " aria-label="Default" style="text-transform:uppercase" value="<?php echo $lista3->country;?>" required >
                            </div>
                        </div>
                    </div>
                </div>
