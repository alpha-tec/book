            ...
            <form class="form-signin"  method="post" action="">
                ...
                <div class="row" id="div_view">
                    ...
                    <div class=" form-group col-sm-2 ">
                        ...
                        <input name="inNumber" type="text" placeholder="" data-msg="Número" class="form-control form-control-sm " aria-label="Default" value="<?php if($id > 0) echo $lista2->house_number; ?>" <?php if($number_focus == 1) echo ' autofocus ';?> required>
                    </div>
