                ...
                <div class="form-inner dashboard-counts" style = "width:100%" >
                            ...
                            if( $cap ) { 
                                if($_POST['inEmail'] == $_POST['inEmail2'])
                                {
                                    ...
                                    if(!$erro)
                                    {
                                        ...
                                        echo "<p>Remover mensagem abaixo depois de configurar e-mail!!!!</p>";
                                        echo "<strong>Login:</strong> {$login}<br>";
                                        echo "<strong>Senha Temporária:</strong> {$passwd}<br>";
                                    echo '</div>';
                                ...
                                else
                                {
                                    ...
                                    Endereço de e-mail não confere! Tente novamente.
                                    </div>';                            
                                }
                            }
                            else
                    ...
                    <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2" >
                        ...
                        <div class="form-group text-center mt-4">
                            <button class="btn btn-success btn-block " name="register" value="1" type="submit">Cadastrar</button>
                        </div>
